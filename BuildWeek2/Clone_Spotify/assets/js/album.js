...
const tracklist = (data) => {
  ...
  let album = `<div class="col-12 album-jb bg-opacity d-flex">
...
const getSong = (data) => {
  for (let i = 0; i < data.tracks.data.length; i++) {
    ...
    let track = `<div class="col-xl-1 d-none d-xl-block text-secondary d-flex justify-content-end align-items-center pt-3">
              ${index}
             </div>
